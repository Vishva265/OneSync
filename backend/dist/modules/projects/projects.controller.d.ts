...
export declare class ProjectsController {
    ...
    constructor(projectsService: ProjectsService, milestonesService: MilestonesService);
    findAll(): Promise<({
        projectManager: {
            email: string;
            fullName: string;
    ...
    createMilestone(projectId: string, body: any): Promise<{
        id: string;
        status: import(".prisma/client").$Enums.MilestoneStatus;
        createdAt: Date;
        updatedAt: Date;
    ...
    updateMilestone(milestoneId: string, body: any): Promise<{
        id: string;
        status: import(".prisma/client").$Enums.MilestoneStatus;
        createdAt: Date;
        updatedAt: Date;
